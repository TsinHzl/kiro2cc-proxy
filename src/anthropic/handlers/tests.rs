...
#[cfg(test)]
mod tests {
    use super::super::super::stream::{SseEvent, StreamContext};
    ...
    use super::super::helpers::resolve_thinking_enabled;
    ...
    use super::super::stream::{stream_interrupted_error_event, wait_deadline};
    ...
    fn sample_search_results() -> crate::anthropic::websearch::WebSearchResults {
